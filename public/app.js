...
const I18N = {
  ...
  'zh-TW': {
    ...
    dockHome: '首頁', dockLottery: '慈善', dockBbs: '廣場', dockIns: '保險', dockMe: '我的', disclaimerTitle: '嚴重聲明', disclaimerAgree: '我已閱讀並同意', lotteryTitle: '幸運抽獎池', lotteryMainTitle: '好人有好報', lotterySubtitle: '一枚最多得5000枚', lotteryRulesTitle: '玩法說明', lotteryRule1: '選擇一個幸運池，投入整數枚數（最少1枚），系統按先來後到分配連續號碼。', lotteryRule2: '號碼售完後，系統自動隨機開獎，完全公平公正，所有人均可查看中獎號碼。', lotteryRule3: '獎金自動發放到您的餘額，可立即提現，不押不申請不審核。', lotteryRule4: '每個號碼中獎概率相同，買得越多中獎機會越大。一期結束自動開啟下一期。', lotteryRule5: '平台收取5%手續費，用於平台運營與慈善捐助。好人有好報，祝您好運！', lotteryPlayers: '人', lotteryRound: '期數', lotterySold: '已售', lotteryProductDesc: '產品說明', lotteryDesc1: '每人投入整數枚數，按先來後到分配連續號碼。號碼售完後系統自動隨機開獎，完全公平公正。', lotteryDesc2: '獎金自動發放到餘額，可立即提現，不押不申請不審核。', lotteryPrizePool: '獎池結構', lotteryBuyNow: '立即購買', lotteryAmount: '投入數量', lotteryConfirmBuy: '確認購買', lotteryMyNumbers: '我的號碼', lotteryNoNumbers: '暫無購買記錄', lotteryNumberRange: '號碼', lotteryHistory: '開獎記錄', lotteryNoHistory: '暫無開獎記錄', lotteryComments: '評論', lotteryCommentPh: '說點什麼...', lotteryNeedAmount: '請輸入有效的數量', lotteryProcessing: '處理中...', lotteryBuySuccess: '購買成功！', lotteryBuyFail: '購買失敗', lotteryNeedWallet: '餘額不足，正在調用錢包...', lotteryWalletCancel: '錢包支付已取消或失敗', lotteryNoComments: '暫無評論', announcement: '系統公告', publishAnnouncement: '發布公告',
