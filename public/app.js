...
const I18N = {
  ...
  'zh-TW': {
    ...
    dockHome: '首頁', dockLottery: '慈善', dockBbs: '廣場', dockIns: '保險', dockMe: '我的', disclaimerTitle: '嚴重聲明', disclaimerAgree: '我已閱讀並同意', lotteryTitle: '幸運抽獎池', lotteryMainTitle: '一等獎50枚', lotterySubtitle: '一枚最多得5000枚', lotteryRulesTitle: '玩法說明', lotteryRule1: '選擇一個幸運池，投入整數枚數（最少1枚），系統按先來後到分配連續號碼。', lotteryRule2: '號碼售完後，系統自動隨機開獎，完全公平公正，所有人均可查看中獎號碼。', lotteryRule3: '獎金自動發放到您的餘額，可立即提現，不押不申請不審核。', lotteryRule4: '每個號碼中獎概率相同，買得越多中獎機會越大。一期結束自動開啟下一期。', lotteryRule5: '平台收取5%手續費，用於平台運營與慈善捐助。好人有好報，祝您好運！', lotteryPlayers: '人', lotteryRound: '期數', lotterySold: '已售', lotteryProductDesc: '產品說明', lotteryDesc1: '每人投入整數枚數，按先來後到分配連續號碼。號碼售完後系統自動隨機開獎，完全公平公正。', lotteryDesc2: '獎金自動發放到餘額，可立即提現，不押不申請不審核。', lotteryPrizePool: '獎池結構', lotteryBuyNow: '立即購買', lotteryAmount: '投入數量', lotteryConfirmBuy: '確認購買', lotteryMyNumbers: '我的號碼', lotteryNoNumbers: '暫無購買記錄', lotteryNumberRange: '號碼', lotteryHistory: '開獎記錄', lotteryNoHistory: '暫無開獎記錄', lotteryComments: '評論', lotteryCommentPh: '說點什麼...', lotteryNeedAmount: '請輸入有效的數量', lotteryProcessing: '處理中...', lotteryBuySuccess: '購買成功！', lotteryBuyFail: '購買失敗', lotteryNeedWallet: '餘額不足，正在調用錢包...', lotteryWalletCancel: '錢包支付已取消或失敗', lotteryNoComments: '暫無評論', announcement: '系統公告', publishAnnouncement: '發布公告',
  ...
  ja: {
    ...
    dockHome: 'ホーム', dockLottery: '慈善', dockBbs: '広場', dockIns: '保険', dockMe: 'マイ', disclaimerTitle: '重大声明', disclaimerAgree: '読んで同意します', lotteryTitle: 'ラッキー抽選プール', lotteryMainTitle: '一等賞50枚', lotterySubtitle: '1枚で最大5000枚獲得', lotteryRulesTitle: '遊び方', lotteryRule1: 'ラッキープールを選び、整数枚（最小1枚）を投入。番号は先着順に連続で割り当てられます。', lotteryRule2: '番号が完売すると、システムが自動的にランダム抽選。完全に公平で透明、誰でも当選番号を確認できます。', lotteryRule3: '賞金は自動的に残高に入金され、すぐに出金可能。保留・申請・審査なし。', lotteryRule4: 'すべての番号の当選確率は同じ。購入するほど当選チャンスが増えます。抽選後は自動的に次のラウンドが開始。', lotteryRule5: 'プラットフォームは運営と慈善寄付のため5%の手数料を徴収。良い人には良い報いが。幸運を！', announcement: 'お知らせ', publishAnnouncement: '公開する',
