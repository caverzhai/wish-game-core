...
const I18N = {
  en: {
    ...
    dockHome: 'Home', dockLottery: 'Lucky', dockBbs: 'Board', dockIns: 'Insurance', dockMe: 'Me', disclaimerTitle: 'Serious Statement', disclaimerAgree: 'I have read and agree', lotteryTitle: 'Lucky Draw Pools', lotteryMainTitle: 'Everyone Needs Donations', lotterySubtitle: 'Up to 5000 coins', lotteryRulesTitle: 'How to Play', lotteryRule1: 'Choose a lucky pool and enter an integer amount (min 1 coin). Numbers are randomly assigned from the remaining pool, not necessarily consecutive.', lotteryRule2: 'When all numbers are sold, the system automatically draws winners randomly. Fully fair and transparent, everyone can view the winning numbers.', lotteryRule3: 'Prize money is automatically credited to your balance and can be withdrawn immediately - no holding, no application, no review.', lotteryRule4: 'Every number has equal odds. The more you buy, the greater your chance. A new round starts automatically after each draw.', lotteryRule5: 'Platform charges 5% fee for operations and charitable donations. Good people get good rewards. Good luck!', lotteryPlayers: 'players', lotteryRound: 'Round', lotterySold: 'sold', lotteryProductDesc: 'Product Description', lotteryDesc1: 'Enter an integer amount, numbers are randomly assigned from the remaining pool. When sold out, the system automatically draws winners randomly - fully fair and transparent.', lotteryDesc2: 'Prize money is automatically credited to your balance and can be withdrawn immediately - no holding, no application, no review.', lotteryPrizePool: 'Prize Structure', lotteryBuyNow: 'Buy Now', lotteryAmount: 'Amount', lotteryConfirmBuy: 'Confirm Buy', lotteryMyNumbers: 'My Numbers', lotteryNoNumbers: 'No purchases yet', lotteryNumberRange: 'Numbers', lotteryHistory: 'Draw History', lotteryNoHistory: 'No draws yet', lotteryComments: 'Comments', lotteryCommentPh: 'Say something...', lotteryNeedAmount: 'Please enter a valid amount', lotteryProcessing: 'Processing...', lotteryBuySuccess: 'Purchase successful!', lotteryBuyFail: 'Purchase failed', lotteryNeedWallet: 'Insufficient balance, charging wallet...', lotteryWalletCancel: 'Wallet payment cancelled or failed', lotteryNoComments: 'No comments yet', seriousNotice: 'Serious Notice', maxDonation: 'Max Donation', prize1: 'First Prize', prize2: 'Second Prize', prize3: 'Third Prize', prize4: 'Fourth Prize', coinUnitLottery: 'coins', howToPlay: 'How to Play', lotteryDescDetail: 'Enter an integer amount (min 1). Numbers are randomly assigned from the remaining pool, not necessarily consecutive. When all numbers are sold, the system automatically draws winners randomly. Prize money is credited to your balance instantly.', wishSuccess1: 'Wish Granted', wishSuccess2: 'Dreams Come True', announcement: 'Announcement', publishAnnouncement: 'Publish', charityApplyBtn: 'Relief Application', charityName: 'Name', charityGender: 'Gender', charityPhoto: 'Photo', charityCountry: 'Country', charityCity: 'City', charityHelpType: 'Help Needed', charityReason: 'Reason', charityAmount: 'Requested Amount', charityProof: 'Proof', charityProofUpload: 'Upload Proof', charitySubmit: 'Submit', charityGoalNote: 'Goal = Requested x 5', charityDonate: 'Donate', charityDonateNow: 'Donate Now', charitySupport: 'Support', charityOppose: 'Oppose', charityVoteNote: 'Only users with insurance nodes can vote. One vote per project, cannot be changed.', charityComments: 'Comments', charityCommentPh: 'Write a comment...', charitySend: 'Send', charityRaised: 'Raised', charityGoal: 'Goal', charityRequested: 'Requested', charityNoProjects: 'No relief applications yet', charityHowToPlay: 'Help Needed', charityBack: 'Back', charityDonated: 'Donated', charityDonor: 'Donor', charityImgTooLarge: 'Image too large, max 2MB', charityPhotoRequired: 'Photo is required', charityPhotoUploadFail: 'Photo upload failed', charityProofUploadFail: 'Proof upload failed', charitySubmitted: 'Submitted successfully!', charitySubmitFail: 'Submission failed', charityError: 'Error', charityLoadFail: 'Failed to load project', charityAmountInvalid: 'Please enter a valid amount', charityDonateSuccess: 'Donation successful!', charityVoteSuccess: 'Vote recorded!', charityCommentSuccess: 'Comment posted!', charityPrizeTitle: 'Prize Distribution', charityPrizeTotal: 'Total Pool', charityPrizeGoal: 'Goal = Requested x 5', charityPrizeRecipient: 'Recipient: 20%', charityPrize1st: '1st Prize: 30% (1 winner)', charityPrize2nd: '2nd Prize: 10% each (2 winners)', charityPrize3rd: '3rd Prize: 2% each (10 winners)', charityPrizePlatform: 'Platform: 10%', charityPrizeNote: 'Each 1 coin donated = 1 lottery ticket. Winners drawn randomly when goal reached. Donations not refunded if not won.', regionTitle: 'Location Verification', regionTip: 'All users must verify their location before the first withdrawal.', regionCountry: 'Country', regionRegion: 'Province/State', regionCity: 'City/Town', regionDistrict: 'District/County', regionTown: 'Town/Street', regionSubmit: 'Submit & Continue', regionRequired: 'All fields are required', myInviter: 'My Inviter', taskSectionTitle: "Find the Right Person", taskPostBtn: "Post Task", taskViewAll: "View All", taskNoTasks: "No tasks yet.", taskReward: "Reward", taskLocation: "Location", taskStatus: "Status", taskApply: "Apply", taskApplyMsg: "Introduce yourself...", taskAccept: "Accept", taskDeliver: "Submit Delivery", taskDeliveryProof: "Delivery Proof", taskConfirm: "Confirm & Release", taskRefuse: "Dispute", taskRequestRefund: "Request Refund", taskAgreeRefund: "Agree Refund", taskVoteSupport: "Support", taskVoteOppose: "Oppose", taskVoteNote: "Only insurance node users can vote.", taskMessages: "Messages", taskSendMsg: "Send", taskMyTasks: "My Tasks", taskBack: "Back", taskTitle: "Title * (min 50 chars)", taskDesc: "Description * (min 100 chars)", taskImage: "Image * (at least one)", taskEscrowNotice: "Platform has collected the full security deposit", taskEscrowDesc: "Reward is escrowed immediately.", taskStatusOpen: "Open", taskStatusAssigned: "Assigned", taskStatusDelivered: "Delivered", taskStatusCompleted: "Completed", taskStatusDisputed: "Disputed", taskStatusCancelled: "Cancelled", taskStatusResolved: "Resolved", taskCreateTitle: "Post a Task", taskTitlePh: "Describe your task clearly in at least 50 characters...", taskLocationPh: "e.g. Hokkaido, Japan (or Remote)", taskRewardPh: "Full payment amount", taskDescPh: "Describe what you need done, timeline, requirements... (at least 100 characters)", taskStatusInProgress: "In Progress", taskPostedByMe: "Posted by me", taskAssignedToMe: "Assigned to me", taskError: "Error", taskTitleRequired: "Title is required", taskTitleMin: "Title must be at least 50 characters", taskTitleNoPunct: "Title cannot contain punctuation or spaces", taskDescRequired: "Description is required", taskDescMin: "Description must be at least 100 characters", taskRewardInvalid: "Reward must be a positive integer", taskImageRequired: "At least one image is required", taskImageTooLarge: "Image too large, max 2MB", taskPostedSuccess: "Task posted successfully! Reward escrowed:", taskPostFail: "Failed", taskApplications: "Applications", taskAccept: "Accept", taskDeliverTitle: "Submit Delivery", taskDeliveryPh: "Describe what you delivered...", taskSubmitDelivery: "Submit Delivery Proof", taskConfirmTitle: "Confirm Delivery", taskAutoReleaseNote: "Auto-release in 15 days if no action.", taskConfirmRelease: "Confirm & Release Payment", taskDispute: "Dispute", taskCancelRefund: "Cancel & Request Refund", taskDisputeTitle: "Dispute", taskVoteSupport: "Support", taskVoteOppose: "Oppose", taskAdminDecision: "Admin decision", taskAgreeRefund: "Agree to Refund (cancel task)", taskPoster: "Poster", taskWorker: "Worker", taskDescription: "Description", taskDeliveryProof: "Delivery Proof", taskDiscussion: "Discussion", taskNoMessages: "No messages yet", taskMsgPh: "Say something...", taskApplySuccess: "Application submitted!", taskApplyFail: "Failed to apply", taskAcceptSuccess: "Applicant accepted!", taskAcceptFail: "Failed to accept", taskDeliveryRequired: "Please enter delivery content", taskDeliverySuccess: "Delivery submitted!", taskDeliveryFail: "Failed to submit delivery", taskConfirmSuccess: "Payment released!", taskConfirmFail: "Failed to confirm", taskDisputeSuccess: "Dispute opened!", taskDisputeFail: "Failed to open dispute", taskRefundSuccess: "Refund requested!", taskRefundFail: "Failed to request refund", taskAgreeRefundSuccess: "Refund agreed, task cancelled.", taskAgreeRefundFail: "Failed to agree refund", taskVoteSuccess: "Vote recorded!", taskVoteFail: "Failed to vote", taskMsgRequired: "Please enter a message", taskMsgFail: "Failed to send message", taskAllTasks: "All Tasks", taskFilterAll: "All", taskFilterOpen: "Open", taskFilterAssigned: "Assigned", taskFilterDone: "Done", taskFilterAll: "All", taskFilterOpen: "Open", taskFilterAssigned: "Assigned", taskFilterDone: "Done", taskFilterAll: "All", taskFilterOpen: "Open", taskFilterAssigned: "Assigned", taskFilterDone: "Done", taskFilterAll: "All", taskFilterOpen: "Open", taskFilterAssigned: "Assigned", taskFilterDone: "Done", taskFilterAll: "All", taskFilterOpen: "Open", taskFilterAssigned: "Assigned", taskFilterDone: "Done", taskFilterAll: "All", taskFilterOpen: "Open", taskFilterAssigned: "Assigned", taskFilterDone: "Done", taskFilterAll: "All", taskFilterOpen: "Open", taskFilterAssigned: "Assigned", taskFilterDone: "Done", taskFilterAll: "全部", taskFilterOpen: "招募中", taskFilterAssigned: "進行中", taskFilterDone: "已完成", taskFilterAll: "全部", taskFilterOpen: "招募中", taskFilterAssigned: "进行中", taskFilterDone: "已完成", taskFilterAll: "All", taskFilterOpen: "Open", taskFilterAssigned: "Assigned", taskFilterDone: "Done", taskCreateTitle: "Post a Task", taskTitlePh: "Describe your task clearly in at least 50 characters...", taskLocationPh: "e.g. Hokkaido, Japan (or Remote)", taskRewardPh: "Full payment amount", taskDescPh: "Describe what you need done, timeline, requirements... (at least 100 characters)", taskStatusInProgress: "In Progress", taskPostedByMe: "Posted by me", taskAssignedToMe: "Assigned to me", taskError: "Error", taskTitleRequired: "Title is required", taskTitleMin: "Title must be at least 50 characters", taskTitleNoPunct: "Title cannot contain punctuation or spaces", taskDescRequired: "Description is required", taskDescMin: "Description must be at least 100 characters", taskRewardInvalid: "Reward must be a positive integer", taskImageRequired: "At least one image is required", taskImageTooLarge: "Image too large, max 2MB", taskPostedSuccess: "Task posted successfully! Reward escrowed:", taskPostFail: "Failed", taskApplications: "Applications", taskAccept: "Accept", taskDeliverTitle: "Submit Delivery", taskDeliveryPh: "Describe what you delivered...", taskSubmitDelivery: "Submit Delivery Proof", taskConfirmTitle: "Confirm Delivery", taskAutoReleaseNote: "Auto-release in 15 days if no action.", taskConfirmRelease: "Confirm & Release Payment", taskDispute: "Dispute", taskCancelRefund: "Cancel & Request Refund", taskDisputeTitle: "Dispute", taskVoteSupport: "Support", taskVoteOppose: "Oppose", taskAdminDecision: "Admin decision", taskAgreeRefund: "Agree to Refund (cancel task)", taskPoster: "Poster", taskWorker: "Worker", taskDescription: "Description", taskDeliveryProof: "Delivery Proof", taskDiscussion: "Discussion", taskNoMessages: "No messages yet", taskMsgPh: "Say something...", taskApplySuccess: "Application submitted!", taskApplyFail: "Failed to apply", taskAcceptSuccess: "Applicant accepted!", taskAcceptFail: "Failed to accept", taskDeliveryRequired: "Please enter delivery content", taskDeliverySuccess: "Delivery submitted!", taskDeliveryFail: "Failed to submit delivery", taskConfirmSuccess: "Payment released!", taskConfirmFail: "Failed to confirm", taskDisputeSuccess: "Dispute opened!", taskDisputeFail: "Failed to open dispute", taskRefundSuccess: "Refund requested!", taskRefundFail: "Failed to request refund", taskAgreeRefundSuccess: "Refund agreed, task cancelled.", taskAgreeRefundFail: "Failed to agree refund", taskVoteSuccess: "Vote recorded!", taskVoteFail: "Failed to vote", taskMsgRequired: "Please enter a message", taskMsgFail: "Failed to send message", taskAllTasks: "All Tasks", taskCreateTitle: "Post a Task", taskTitlePh: "Describe your task clearly in at least 50 characters...", taskLocationPh: "e.g. Hokkaido, Japan (or Remote)", taskRewardPh: "Full payment amount", taskDescPh: "Describe what you need done, timeline, requirements... (at least 100 characters)", taskStatusInProgress: "In Progress", taskPostedByMe: "Posted by me", taskAssignedToMe: "Assigned to me", taskError: "Error", taskTitleRequired: "Title is required", taskTitleMin: "Title must be at least 50 characters", taskTitleNoPunct: "Title cannot contain punctuation or spaces", taskDescRequired: "Description is required", taskDescMin: "Description must be at least 100 characters", taskRewardInvalid: "Reward must be a positive integer", taskImageRequired: "At least one image is required", taskImageTooLarge: "Image too large, max 2MB", taskPostedSuccess: "Task posted successfully! Reward escrowed:", taskPostFail: "Failed", taskApplications: "Applications", taskAccept: "Accept", taskDeliverTitle: "Submit Delivery", taskDeliveryPh: "Describe what you delivered...", taskSubmitDelivery: "Submit Delivery Proof", taskConfirmTitle: "Confirm Delivery", taskAutoReleaseNote: "Auto-release in 15 days if no action.", taskConfirmRelease: "Confirm & Release Payment", taskDispute: "Dispute", taskCancelRefund: "Cancel & Request Refund", taskDisputeTitle: "Dispute", taskVoteSupport: "Support", taskVoteOppose: "Oppose", taskAdminDecision: "Admin decision", taskAgreeRefund: "Agree to Refund (cancel task)", taskPoster: "Poster", taskWorker: "Worker", taskDescription: "Description", taskDeliveryProof: "Delivery Proof", taskDiscussion: "Discussion", taskNoMessages: "No messages yet", taskMsgPh: "Say something...", taskApplySuccess: "Application submitted!", taskApplyFail: "Failed to apply", taskAcceptSuccess: "Applicant accepted!", taskAcceptFail: "Failed to accept", taskDeliveryRequired: "Please enter delivery content", taskDeliverySuccess: "Delivery submitted!", taskDeliveryFail: "Failed to submit delivery", taskConfirmSuccess: "Payment released!", taskConfirmFail: "Failed to confirm", taskDisputeSuccess: "Dispute opened!", taskDisputeFail: "Failed to open dispute", taskRefundSuccess: "Refund requested!", taskRefundFail: "Failed to request refund", taskAgreeRefundSuccess: "Refund agreed, task cancelled.", taskAgreeRefundFail: "Failed to agree refund", taskVoteSuccess: "Vote recorded!", taskVoteFail: "Failed to vote", taskMsgRequired: "Please enter a message", taskMsgFail: "Failed to send message", taskAllTasks: "All Tasks", taskCreateTitle: "Post a Task", taskTitlePh: "Describe your task clearly in at least 50 characters...", taskLocationPh: "e.g. Hokkaido, Japan (or Remote)", taskRewardPh: "Full payment amount", taskDescPh: "Describe what you need done, timeline, requirements... (at least 100 characters)", taskStatusInProgress: "In Progress", taskPostedByMe: "Posted by me", taskAssignedToMe: "Assigned to me", taskError: "Error", taskTitleRequired: "Title is required", taskTitleMin: "Title must be at least 50 characters", taskTitleNoPunct: "Title cannot contain punctuation or spaces", taskDescRequired: "Description is required", taskDescMin: "Description must be at least 100 characters", taskRewardInvalid: "Reward must be a positive integer", taskImageRequired: "At least one image is required", taskImageTooLarge: "Image too large, max 2MB", taskPostedSuccess: "Task posted successfully! Reward escrowed:", taskPostFail: "Failed", taskApplications: "Applications", taskAccept: "Accept", taskDeliverTitle: "Submit Delivery", taskDeliveryPh: "Describe what you delivered...", taskSubmitDelivery: "Submit Delivery Proof", taskConfirmTitle: "Confirm Delivery", taskAutoReleaseNote: "Auto-release in 15 days if no action.", taskConfirmRelease: "Confirm & Release Payment", taskDispute: "Dispute", taskCancelRefund: "Cancel & Request Refund", taskDisputeTitle: "Dispute", taskVoteSupport: "Support", taskVoteOppose: "Oppose", taskAdminDecision: "Admin decision", taskAgreeRefund: "Agree to Refund (cancel task)", taskPoster: "Poster", taskWorker: "Worker", taskDescription: "Description", taskDeliveryProof: "Delivery Proof", taskDiscussion: "Discussion", taskNoMessages: "No messages yet", taskMsgPh: "Say something...", taskApplySuccess: "Application submitted!", taskApplyFail: "Failed to apply", taskAcceptSuccess: "Applicant accepted!", taskAcceptFail: "Failed to accept", taskDeliveryRequired: "Please enter delivery content", taskDeliverySuccess: "Delivery submitted!", taskDeliveryFail: "Failed to submit delivery", taskConfirmSuccess: "Payment released!", taskConfirmFail: "Failed to confirm", taskDisputeSuccess: "Dispute opened!", taskDisputeFail: "Failed to open dispute", taskRefundSuccess: "Refund requested!", taskRefundFail: "Failed to request refund", taskAgreeRefundSuccess: "Refund agreed, task cancelled.", taskAgreeRefundFail: "Failed to agree refund", taskVoteSuccess: "Vote recorded!", taskVoteFail: "Failed to vote", taskMsgRequired: "Please enter a message", taskMsgFail: "Failed to send message", taskAllTasks: "All Tasks", taskCreateTitle: "Post a Task", taskTitlePh: "Describe your task clearly in at least 50 characters...", taskLocationPh: "e.g. Hokkaido, Japan (or Remote)", taskRewardPh: "Full payment amount", taskDescPh: "Describe what you need done, timeline, requirements... (at least 100 characters)", taskStatusInProgress: "In Progress", taskPostedByMe: "Posted by me", taskAssignedToMe: "Assigned to me", taskError: "Error", taskTitleRequired: "Title is required", taskTitleMin: "Title must be at least 50 characters", taskTitleNoPunct: "Title cannot contain punctuation or spaces", taskDescRequired: "Description is required", taskDescMin: "Description must be at least 100 characters", taskRewardInvalid: "Reward must be a positive integer", taskImageRequired: "At least one image is required", taskImageTooLarge: "Image too large, max 2MB", taskPostedSuccess: "Task posted successfully! Reward escrowed:", taskPostFail: "Failed", taskApplications: "Applications", taskAccept: "Accept", taskDeliverTitle: "Submit Delivery", taskDeliveryPh: "Describe what you delivered...", taskSubmitDelivery: "Submit Delivery Proof", taskConfirmTitle: "Confirm Delivery", taskAutoReleaseNote: "Auto-release in 15 days if no action.", taskConfirmRelease: "Confirm & Release Payment", taskDispute: "Dispute", taskCancelRefund: "Cancel & Request Refund", taskDisputeTitle: "Dispute", taskVoteSupport: "Support", taskVoteOppose: "Oppose", taskAdminDecision: "Admin decision", taskAgreeRefund: "Agree to Refund (cancel task)", taskPoster: "Poster", taskWorker: "Worker", taskDescription: "Description", taskDeliveryProof: "Delivery Proof", taskDiscussion: "Discussion", taskNoMessages: "No messages yet", taskMsgPh: "Say something...", taskApplySuccess: "Application submitted!", taskApplyFail: "Failed to apply", taskAcceptSuccess: "Applicant accepted!", taskAcceptFail: "Failed to accept", taskDeliveryRequired: "Please enter delivery content", taskDeliverySuccess: "Delivery submitted!", taskDeliveryFail: "Failed to submit delivery", taskConfirmSuccess: "Payment released!", taskConfirmFail: "Failed to confirm", taskDisputeSuccess: "Dispute opened!", taskDisputeFail: "Failed to open dispute", taskRefundSuccess: "Refund requested!", taskRefundFail: "Failed to request refund", taskAgreeRefundSuccess: "Refund agreed, task cancelled.", taskAgreeRefundFail: "Failed to agree refund", taskVoteSuccess: "Vote recorded!", taskVoteFail: "Failed to vote", taskMsgRequired: "Please enter a message", taskMsgFail: "Failed to send message", taskAllTasks: "All Tasks", taskCreateTitle: "Post a Task", taskTitlePh: "Describe your task clearly in at least 50 characters...", taskLocationPh: "e.g. Hokkaido, Japan (or Remote)", taskRewardPh: "Full payment amount", taskDescPh: "Describe what you need done, timeline, requirements... (at least 100 characters)", taskStatusInProgress: "In Progress", taskPostedByMe: "Posted by me", taskAssignedToMe: "Assigned to me", taskError: "Error", taskTitleRequired: "Title is required", taskTitleMin: "Title must be at least 50 characters", taskTitleNoPunct: "Title cannot contain punctuation or spaces", taskDescRequired: "Description is required", taskDescMin: "Description must be at least 100 characters", taskRewardInvalid: "Reward must be a positive integer", taskImageRequired: "At least one image is required", taskImageTooLarge: "Image too large, max 2MB", taskPostedSuccess: "Task posted successfully! Reward escrowed:", taskPostFail: "Failed", taskApplications: "Applications", taskAccept: "Accept", taskDeliverTitle: "Submit Delivery", taskDeliveryPh: "Describe what you delivered...", taskSubmitDelivery: "Submit Delivery Proof", taskConfirmTitle: "Confirm Delivery", taskAutoReleaseNote: "Auto-release in 15 days if no action.", taskConfirmRelease: "Confirm & Release Payment", taskDispute: "Dispute", taskCancelRefund: "Cancel & Request Refund", taskDisputeTitle: "Dispute", taskVoteSupport: "Support", taskVoteOppose: "Oppose", taskAdminDecision: "Admin decision", taskAgreeRefund: "Agree to Refund (cancel task)", taskPoster: "Poster", taskWorker: "Worker", taskDescription: "Description", taskDeliveryProof: "Delivery Proof", taskDiscussion: "Discussion", taskNoMessages: "No messages yet", taskMsgPh: "Say something...", taskApplySuccess: "Application submitted!", taskApplyFail: "Failed to apply", taskAcceptSuccess: "Applicant accepted!", taskAcceptFail: "Failed to accept", taskDeliveryRequired: "Please enter delivery content", taskDeliverySuccess: "Delivery submitted!", taskDeliveryFail: "Failed to submit delivery", taskConfirmSuccess: "Payment released!", taskConfirmFail: "Failed to confirm", taskDisputeSuccess: "Dispute opened!", taskDisputeFail: "Failed to open dispute", taskRefundSuccess: "Refund requested!", taskRefundFail: "Failed to request refund", taskAgreeRefundSuccess: "Refund agreed, task cancelled.", taskAgreeRefundFail: "Failed to agree refund", taskVoteSuccess: "Vote recorded!", taskVoteFail: "Failed to vote", taskMsgRequired: "Please enter a message", taskMsgFail: "Failed to send message", taskAllTasks: "All Tasks", taskCreateTitle: "Post a Task", taskTitlePh: "Describe your task clearly in at least 50 characters...", taskLocationPh: "e.g. Hokkaido, Japan (or Remote)", taskRewardPh: "Full payment amount", taskDescPh: "Describe what you need done, timeline, requirements... (at least 100 characters)", taskStatusInProgress: "In Progress", taskPostedByMe: "Posted by me", taskAssignedToMe: "Assigned to me", taskError: "Error", taskTitleRequired: "Title is required", taskTitleMin: "Title must be at least 50 characters", taskTitleNoPunct: "Title cannot contain punctuation or spaces", taskDescRequired: "Description is required", taskDescMin: "Description must be at least 100 characters", taskRewardInvalid: "Reward must be a positive integer", taskImageRequired: "At least one image is required", taskImageTooLarge: "Image too large, max 2MB", taskPostedSuccess: "Task posted successfully! Reward escrowed:", taskPostFail: "Failed", taskApplications: "Applications", taskAccept: "Accept", taskDeliverTitle: "Submit Delivery", taskDeliveryPh: "Describe what you delivered...", taskSubmitDelivery: "Submit Delivery Proof", taskConfirmTitle: "Confirm Delivery", taskAutoReleaseNote: "Auto-release in 15 days if no action.", taskConfirmRelease: "Confirm & Release Payment", taskDispute: "Dispute", taskCancelRefund: "Cancel & Request Refund", taskDisputeTitle: "Dispute", taskVoteSupport: "Support", taskVoteOppose: "Oppose", taskAdminDecision: "Admin decision", taskAgreeRefund: "Agree to Refund (cancel task)", taskPoster: "Poster", taskWorker: "Worker", taskDescription: "Description", taskDeliveryProof: "Delivery Proof", taskDiscussion: "Discussion", taskNoMessages: "No messages yet", taskMsgPh: "Say something...", taskApplySuccess: "Application submitted!", taskApplyFail: "Failed to apply", taskAcceptSuccess: "Applicant accepted!", taskAcceptFail: "Failed to accept", taskDeliveryRequired: "Please enter delivery content", taskDeliverySuccess: "Delivery submitted!", taskDeliveryFail: "Failed to submit delivery", taskConfirmSuccess: "Payment released!", taskConfirmFail: "Failed to confirm", taskDisputeSuccess: "Dispute opened!", taskDisputeFail: "Failed to open dispute", taskRefundSuccess: "Refund requested!", taskRefundFail: "Failed to request refund", taskAgreeRefundSuccess: "Refund agreed, task cancelled.", taskAgreeRefundFail: "Failed to agree refund", taskVoteSuccess: "Vote recorded!", taskVoteFail: "Failed to vote", taskMsgRequired: "Please enter a message", taskMsgFail: "Failed to send message", taskAllTasks: "All Tasks", taskCreateTitle: "發布任務", taskTitlePh: "用至少50個字元清楚描述你的任務...", taskLocationPh: "例如：日本北海道（或遠端）", taskRewardPh: "全額報酬", taskDescPh: "描述你需要做什麼、時間線、要求...（至少100個字元）", taskStatusInProgress: "進行中", taskPostedByMe: "我發布的", taskAssignedToMe: "分配給我的", taskError: "錯誤", taskTitleRequired: "標題不能為空", taskTitleMin: "標題至少50個字元", taskTitleNoPunct: "標題不能包含標點和空格", taskDescRequired: "描述不能為空", taskDescMin: "描述至少100個字元", taskRewardInvalid: "報酬必須是正整數", taskImageRequired: "至少上傳一張圖片", taskImageTooLarge: "圖片太大，最大2MB", taskPostedSuccess: "任務發布成功！報酬已託管：", taskPostFail: "失敗", taskApplications: "申請列表", taskAccept: "接受", taskDeliverTitle: "提交交付", taskDeliveryPh: "描述你交付了什麼...", taskSubmitDelivery: "提交交付證明", taskConfirmTitle: "確認交付", taskAutoReleaseNote: "15天內無操作將自動放款。", taskConfirmRelease: "確認並放款", taskDispute: "糾紛", taskCancelRefund: "取消並申請退款", taskDisputeTitle: "糾紛", taskVoteSupport: "支持", taskVoteOppose: "反對", taskAdminDecision: "管理員裁定", taskAgreeRefund: "同意退款（取消任務）", taskPoster: "發布者", taskWorker: "接單方", taskDescription: "任務描述", taskDeliveryProof: "交付證明", taskDiscussion: "討論", taskNoMessages: "暫無留言", taskMsgPh: "說點什麼...", taskApplySuccess: "申請已提交！", taskApplyFail: "申請失敗", taskAcceptSuccess: "已接受申請！", taskAcceptFail: "接受失敗", taskDeliveryRequired: "請輸入交付內容", taskDeliverySuccess: "交付已提交！", taskDeliveryFail: "提交交付失敗", taskConfirmSuccess: "已放款！", taskConfirmFail: "確認失敗", taskDisputeSuccess: "糾紛已開啟！", taskDisputeFail: "開啟糾紛失敗", taskRefundSuccess: "退款申請已提交！", taskRefundFail: "退款申請失敗", taskAgreeRefundSuccess: "已同意退款，任務取消。", taskAgreeRefundFail: "同意退款失敗", taskVoteSuccess: "投票成功！", taskVoteFail: "投票失敗", taskMsgRequired: "請輸入留言", taskMsgFail: "發送留言失敗", taskAllTasks: "全部任務", taskCreateTitle: "发布任务", taskTitlePh: "用至少50个字符清楚描述你的任务...", taskLocationPh: "例如：日本北海道（或远程）", taskRewardPh: "全额报酬", taskDescPh: "描述你需要做什么、时间线、要求...（至少100个字符）", taskStatusInProgress: "进行中", taskPostedByMe: "我发布的", taskAssignedToMe: "分配给我的", taskError: "错误", taskTitleRequired: "标题不能为空", taskTitleMin: "标题至少50个字符", taskTitleNoPunct: "标题不能包含标点和空格", taskDescRequired: "描述不能为空", taskDescMin: "描述至少100个字符", taskRewardInvalid: "报酬必须是正整数", taskImageRequired: "至少上传一张图片", taskImageTooLarge: "图片太大，最大2MB", taskPostedSuccess: "任务发布成功！报酬已托管：", taskPostFail: "失败", taskApplications: "申请列表", taskAccept: "接受", taskDeliverTitle: "提交交付", taskDeliveryPh: "描述你交付了什么...", taskSubmitDelivery: "提交交付证明", taskConfirmTitle: "确认交付", taskAutoReleaseNote: "15天内无操作将自动放款。", taskConfirmRelease: "确认并放款", taskDispute: "纠纷", taskCancelRefund: "取消并申请退款", taskDisputeTitle: "纠纷", taskVoteSupport: "支持", taskVoteOppose: "反对", taskAdminDecision: "管理员裁定", taskAgreeRefund: "同意退款（取消任务）", taskPoster: "发布者", taskWorker: "接单方", taskDescription: "任务描述", taskDeliveryProof: "交付证明", taskDiscussion: "讨论", taskNoMessages: "暂无留言", taskMsgPh: "说点什么...", taskApplySuccess: "申请已提交！", taskApplyFail: "申请失败", taskAcceptSuccess: "已接受申请！", taskAcceptFail: "接受失败", taskDeliveryRequired: "请输入交付内容", taskDeliverySuccess: "交付已提交！", taskDeliveryFail: "提交交付失败", taskConfirmSuccess: "已放款！", taskConfirmFail: "确认失败", taskDisputeSuccess: "纠纷已开启！", taskDisputeFail: "开启纠纷失败", taskRefundSuccess: "退款申请已提交！", taskRefundFail: "退款申请失败", taskAgreeRefundSuccess: "已同意退款，任务取消。", taskAgreeRefundFail: "同意退款失败", taskVoteSuccess: "投票成功！", taskVoteFail: "投票失败", taskMsgRequired: "请输入留言", taskMsgFail: "发送留言失败", taskAllTasks: "全部任务", taskCreateTitle: "Post a Task", taskTitlePh: "Describe your task clearly in at least 50 characters...", taskLocationPh: "e.g. Hokkaido, Japan (or Remote)", taskRewardPh: "Full payment amount", taskDescPh: "Describe what you need done, timeline, requirements... (at least 100 characters)", taskStatusInProgress: "In Progress", taskPostedByMe: "Posted by me", taskAssignedToMe: "Assigned to me", taskError: "Error", taskTitleRequired: "Title is required", taskTitleMin: "Title must be at least 50 characters", taskTitleNoPunct: "Title cannot contain punctuation or spaces", taskDescRequired: "Description is required", taskDescMin: "Description must be at least 100 characters", taskRewardInvalid: "Reward must be a positive integer", taskImageRequired: "At least one image is required", taskImageTooLarge: "Image too large, max 2MB", taskPostedSuccess: "Task posted successfully! Reward escrowed:", taskPostFail: "Failed", taskApplications: "Applications", taskAccept: "Accept", taskDeliverTitle: "Submit Delivery", taskDeliveryPh: "Describe what you delivered...", taskSubmitDelivery: "Submit Delivery Proof", taskConfirmTitle: "Confirm Delivery", taskAutoReleaseNote: "Auto-release in 15 days if no action.", taskConfirmRelease: "Confirm & Release Payment", taskDispute: "Dispute", taskCancelRefund: "Cancel & Request Refund", taskDisputeTitle: "Dispute", taskVoteSupport: "Support", taskVoteOppose: "Oppose", taskAdminDecision: "Admin decision", taskAgreeRefund: "Agree to Refund (cancel task)", taskPoster: "Poster", taskWorker: "Worker", taskDescription: "Description", taskDeliveryProof: "Delivery Proof", taskDiscussion: "Discussion", taskNoMessages: "No messages yet", taskMsgPh: "Say something...", taskApplySuccess: "Application submitted!", taskApplyFail: "Failed to apply", taskAcceptSuccess: "Applicant accepted!", taskAcceptFail: "Failed to accept", taskDeliveryRequired: "Please enter delivery content", taskDeliverySuccess: "Delivery submitted!", taskDeliveryFail: "Failed to submit delivery", taskConfirmSuccess: "Payment released!", taskConfirmFail: "Failed to confirm", taskDisputeSuccess: "Dispute opened!", taskDisputeFail: "Failed to open dispute", taskRefundSuccess: "Refund requested!", taskRefundFail: "Failed to request refund", taskAgreeRefundSuccess: "Refund agreed, task cancelled.", taskAgreeRefundFail: "Failed to agree refund", taskVoteSuccess: "Vote recorded!", taskVoteFail: "Failed to vote", taskMsgRequired: "Please enter a message", taskMsgFail: "Failed to send message", taskAllTasks: "All Tasks", taskSectionTitle: "Find the Right Person", taskPostBtn: "Post Task", taskViewAll: "View All", taskNoTasks: "No tasks yet.", taskReward: "Reward", taskLocation: "Location", taskStatus: "Status", taskApply: "Apply", taskApplyMsg: "Introduce yourself...", taskAccept: "Accept", taskDeliver: "Submit Delivery", taskDeliveryProof: "Delivery Proof", taskConfirm: "Confirm & Release", taskRefuse: "Dispute", taskRequestRefund: "Request Refund", taskAgreeRefund: "Agree Refund", taskVoteSupport: "Support", taskVoteOppose: "Oppose", taskVoteNote: "Only insurance node users can vote.", taskMessages: "Messages", taskSendMsg: "Send", taskMyTasks: "My Tasks", taskBack: "Back", taskTitle: "Title * (min 50 chars)", taskDesc: "Description * (min 100 chars)", taskImage: "Image * (at least one)", taskEscrowNotice: "Platform has collected the full security deposit", taskEscrowDesc: "Reward is escrowed immediately.", taskStatusOpen: "Open", taskStatusAssigned: "Assigned", taskStatusDelivered: "Delivered", taskStatusCompleted: "Completed", taskStatusDisputed: "Disputed", taskStatusCancelled: "Cancelled", taskStatusResolved: "Resolved", taskSectionTitle: "Find the Right Person", taskPostBtn: "Post Task", taskViewAll: "View All", taskNoTasks: "No tasks yet.", taskReward: "Reward", taskLocation: "Location", taskStatus: "Status", taskApply: "Apply", taskApplyMsg: "Introduce yourself...", taskAccept: "Accept", taskDeliver: "Submit Delivery", taskDeliveryProof: "Delivery Proof", taskConfirm: "Confirm & Release", taskRefuse: "Dispute", taskRequestRefund: "Request Refund", taskAgreeRefund: "Agree Refund", taskVoteSupport: "Support", taskVoteOppose: "Oppose", taskVoteNote: "Only insurance node users can vote.", taskMessages: "Messages", taskSendMsg: "Send", taskMyTasks: "My Tasks", taskBack: "Back", taskTitle: "Title * (min 50 chars)", taskDesc: "Description * (min 100 chars)", taskImage: "Image * (at least one)", taskEscrowNotice: "Platform has collected the full security deposit", taskEscrowDesc: "Reward is escrowed immediately.", taskStatusOpen: "Open", taskStatusAssigned: "Assigned", taskStatusDelivered: "Delivered", taskStatusCompleted: "Completed", taskStatusDisputed: "Disputed", taskStatusCancelled: "Cancelled", taskStatusResolved: "Resolved", taskSectionTitle: "Find the Right Person", taskPostBtn: "Post Task", taskViewAll: "View All", taskNoTasks: "No tasks yet.", taskReward: "Reward", taskLocation: "Location", taskStatus: "Status", taskApply: "Apply", taskApplyMsg: "Introduce yourself...", taskAccept: "Accept", taskDeliver: "Submit Delivery", taskDeliveryProof: "Delivery Proof", taskConfirm: "Confirm & Release", taskRefuse: "Dispute", taskRequestRefund: "Request Refund", taskAgreeRefund: "Agree Refund", taskVoteSupport: "Support", taskVoteOppose: "Oppose", taskVoteNote: "Only insurance node users can vote.", taskMessages: "Messages", taskSendMsg: "Send", taskMyTasks: "My Tasks", taskBack: "Back", taskTitle: "Title * (min 50 chars)", taskDesc: "Description * (min 100 chars)", taskImage: "Image * (at least one)", taskEscrowNotice: "Platform has collected the full security deposit", taskEscrowDesc: "Reward is escrowed immediately.", taskStatusOpen: "Open", taskStatusAssigned: "Assigned", taskStatusDelivered: "Delivered", taskStatusCompleted: "Completed", taskStatusDisputed: "Disputed", taskStatusCancelled: "Cancelled", taskStatusResolved: "Resolved", taskSectionTitle: "Find the Right Person", taskPostBtn: "Post Task", taskViewAll: "View All", taskNoTasks: "No tasks yet.", taskReward: "Reward", taskLocation: "Location", taskStatus: "Status", taskApply: "Apply", taskApplyMsg: "Introduce yourself...", taskAccept: "Accept", taskDeliver: "Submit Delivery", taskDeliveryProof: "Delivery Proof", taskConfirm: "Confirm & Release", taskRefuse: "Dispute", taskRequestRefund: "Request Refund", taskAgreeRefund: "Agree Refund", taskVoteSupport: "Support", taskVoteOppose: "Oppose", taskVoteNote: "Only insurance node users can vote.", taskMessages: "Messages", taskSendMsg: "Send", taskMyTasks: "My Tasks", taskBack: "Back", taskTitle: "Title * (min 50 chars)", taskDesc: "Description * (min 100 chars)", taskImage: "Image * (at least one)", taskEscrowNotice: "Platform has collected the full security deposit", taskEscrowDesc: "Reward is escrowed immediately.", taskStatusOpen: "Open", taskStatusAssigned: "Assigned", taskStatusDelivered: "Delivered", taskStatusCompleted: "Completed", taskStatusDisputed: "Disputed", taskStatusCancelled: "Cancelled", taskStatusResolved: "Resolved", taskSectionTitle: "Find the Right Person", taskPostBtn: "Post Task", taskViewAll: "View All", taskNoTasks: "No tasks yet.", taskReward: "Reward", taskLocation: "Location", taskStatus: "Status", taskApply: "Apply", taskApplyMsg: "Introduce yourself...", taskAccept: "Accept", taskDeliver: "Submit Delivery", taskDeliveryProof: "Delivery Proof", taskConfirm: "Confirm & Release", taskRefuse: "Dispute", taskRequestRefund: "Request Refund", taskAgreeRefund: "Agree Refund", taskVoteSupport: "Support", taskVoteOppose: "Oppose", taskVoteNote: "Only insurance node users can vote.", taskMessages: "Messages", taskSendMsg: "Send", taskMyTasks: "My Tasks", taskBack: "Back", taskTitle: "Title * (min 50 chars)", taskDesc: "Description * (min 100 chars)", taskImage: "Image * (at least one)", taskEscrowNotice: "Platform has collected the full security deposit", taskEscrowDesc: "Reward is escrowed immediately.", taskStatusOpen: "Open", taskStatusAssigned: "Assigned", taskStatusDelivered: "Delivered", taskStatusCompleted: "Completed", taskStatusDisputed: "Disputed", taskStatusCancelled: "Cancelled", taskStatusResolved: "Resolved", taskSectionTitle: "Find the Right Person", taskPostBtn: "Post Task", taskViewAll: "View All", taskNoTasks: "No tasks yet. Be the first to post!", taskReward: "Reward", taskLocation: "Location", taskStatus: "Status", taskApply: "Apply", taskApplyMsg: "Introduce yourself...", taskAccept: "Accept", taskDeliver: "Submit Delivery", taskDeliveryProof: "Delivery Proof", taskConfirm: "Confirm & Release", taskRefuse: "Dispute", taskRequestRefund: "Request Refund", taskAgreeRefund: "Agree Refund", taskVoteSupport: "Support", taskVoteOppose: "Oppose", taskVoteNote: "Only insurance node users can vote.", taskMessages: "Messages", taskSendMsg: "Send", taskMyTasks: "My Tasks", taskBack: "Back", taskTitle: "Title * (min 50 chars, no punctuation or spaces)", taskDesc: "Description * (min 100 chars)", taskImage: "Image * (at least one)", taskEscrowNotice: "Platform has collected the full security deposit", taskEscrowDesc: "Reward is escrowed immediately.", taskStatusOpen: "Open", taskStatusAssigned: "Assigned", taskStatusDelivered: "Delivered", taskStatusCompleted: "Completed", taskStatusDisputed: "Disputed", taskStatusCancelled: "Cancelled", taskStatusResolved: "Resolved", taskSectionTitle: "找對人", taskPostBtn: "發布任務", taskViewAll: "查看全部", taskNoTasks: "暫無任務，快來發布第一個吧！", taskReward: "報酬", taskLocation: "地點", taskStatus: "狀態", taskApply: "申請接單", taskApplyMsg: "介紹一下你自己...", taskAccept: "確認接單", taskDeliver: "提交交付", taskDeliveryProof: "交付說明", taskConfirm: "確認並放款", taskRefuse: "拒絕放款", taskRequestRefund: "申請退款", taskAgreeRefund: "同意退款", taskVoteSupport: "支持", taskVoteOppose: "反對", taskVoteNote: "只有保險節點用戶可以投票，每個糾紛一票。", taskMessages: "留言", taskSendMsg: "發送", taskMyTasks: "我的任務", taskBack: "返回", taskTitle: "標題 *（至少50字，不能有標點和空格）", taskDesc: "描述 *（至少100字）", taskImage: "圖片 *（至少一張）", taskEscrowNotice: "平台已收取全額保證金", taskEscrowDesc: "報酬立即託管，確認交付後釋放。", taskStatusOpen: "招募中", taskStatusAssigned: "已接單", taskStatusDelivered: "已交付", taskStatusCompleted: "已完成", taskStatusDisputed: "糾紛中", taskStatusCancelled: "已取消", taskStatusResolved: "已解決", taskSectionTitle: "找对人", taskPostBtn: "发布任务", taskViewAll: "查看全部", taskNoTasks: "暂无任务，快来发布第一个吧！", taskReward: "报酬", taskLocation: "地点", taskStatus: "状态", taskApply: "申请接单", taskApplyMsg: "介绍一下你自己...", taskAccept: "确认接单", taskDeliver: "提交交付", taskDeliveryProof: "交付说明", taskConfirm: "确认并放款", taskRefuse: "拒绝放款", taskRequestRefund: "申请退款", taskAgreeRefund: "同意退款", taskVoteSupport: "支持", taskVoteOppose: "反对", taskVoteNote: "只有保险节点用户可以投票，每个纠纷一票。", taskMessages: "留言", taskSendMsg: "发送", taskMyTasks: "我的任务", taskBack: "返回", taskTitle: "标题 *（至少50字，不能有标点和空格）", taskDesc: "描述 *（至少100字）", taskImage: "图片 *（至少一张）", taskEscrowNotice: "平台已收取全额保证金", taskEscrowDesc: "报酬立即托管，确认交付后释放。", taskStatusOpen: "招募中", taskStatusAssigned: "已接单", taskStatusDelivered: "已交付", taskStatusCompleted: "已完成", taskStatusDisputed: "纠纷中", taskStatusCancelled: "已取消", taskStatusResolved: "已解决", taskSectionTitle: "Find the Right Person", taskPostBtn: "Post Task", taskViewAll: "View All", taskNoTasks: "No tasks yet. Be the first to post!", taskReward: "Reward", taskLocation: "Location", taskStatus: "Status", taskApply: "Apply", taskApplyMsg: "Introduce yourself...", taskAccept: "Accept", taskDeliver: "Submit Delivery", taskDeliveryProof: "Delivery Proof (text)", taskConfirm: "Confirm & Release Payment", taskRefuse: "Dispute Payment", taskRequestRefund: "Request Refund", taskAgreeRefund: "Agree to Refund", taskVoteSupport: "Support", taskVoteOppose: "Oppose", taskVoteNote: "Only users with insurance nodes can vote. One vote per dispute.", taskMessages: "Messages", taskSendMsg: "Send", taskMyTasks: "My Tasks", taskBack: "Back", taskTitle: "Title * (min 50 chars, no punctuation or spaces)", taskDesc: "Description * (min 100 chars)", taskImage: "Image * (at least one)", taskEscrowNotice: "Platform has collected the full security deposit", taskEscrowDesc: "Reward is escrowed immediately. Released after confirmed delivery.", taskStatusOpen: "Open", taskStatusAssigned: "Assigned", taskStatusDelivered: "Delivered", taskStatusCompleted: "Completed", taskStatusDisputed: "Disputed", taskStatusCancelled: "Cancelled", taskStatusResolved: "Resolved",
