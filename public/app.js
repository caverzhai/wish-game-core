...
const I18N = {
  ...
  'zh-TW': {
    coinUnit: '枚', platformTitle: '全球自助慈善捐助平台', platformDesc: '阿姆斯特丹團隊致力為全球有需要的人士提供直接捐助，以區塊鏈模式，公開、公正、可追溯的自由捐贈撮合服務，除了讓需要的人得到無損資助外，讓愛心人士也能得到肯定和收益。受所屬國家法律保護，相關證書展示在保險區。', appTitle: '許願池', loginTip: '連接錢包即可開始，邀請連結自動綁定推薦關係', connectWallet: '連接錢包', demoEnter: '未裝錢包？以演示身份進入', logout: '退出',
    dockHome: '首頁', dockLottery: '慈善', dockBbs: '廣場', dockIns: '保險', dockMe: '我的', disclaimerTitle: '嚴重聲明', disclaimerAgree: '我已閱讀並同意', lotteryTitle: '幸運抽獎池', lotteryMainTitle: '每個人都需要被捐助', lotterySubtitle: '最多可以得5000', lotteryRulesTitle: '玩法說明', lotteryRule1: '選擇一個幸運池，投入整數枚數（最少1枚），系統按先來後到分配連續號碼。', lotteryRule2: '號碼售完後，系統自動隨機開獎，完全公平公正，所有人均可查看中獎號碼。', lotteryRule3: '獎金自動發放到您的餘額，可立即提現，不押不申請不審核。', lotteryRule4: '每個號碼中獎概率相同，買得越多中獎機會越大。一期結束自動開啟下一期。', lotteryRule5: '平台收取5%手續費，用於平台運營與慈善捐助。好人有好報，祝您好運！', lotteryPlayers: '人', lotteryRound: '期數', lotterySold: '已售', lotteryProductDesc: '產品說明', lotteryDesc1: '每人投入整數枚數，按先來後到分配連續號碼。號碼售完後系統自動隨機開獎，完全公平公正。', lotteryDesc2: '獎金自動發放到餘額，可立即提現，不押不申請不審核。', lotteryPrizePool: '獎池結構', lotteryBuyNow: '立即購買', lotteryAmount: '投入數量', lotteryConfirmBuy: '確認購買', lotteryMyNumbers: '我的號碼', lotteryNoNumbers: '暫無購買記錄', lotteryNumberRange: '號碼', lotteryHistory: '開獎記錄', lotteryNoHistory: '暫無開獎記錄', lotteryComments: '評論', lotteryCommentPh: '說點什麼...', lotteryNeedAmount: '請輸入有效的數量', lotteryProcessing: '處理中...', lotteryBuySuccess: '購買成功！', lotteryBuyFail: '購買失敗', lotteryNeedWallet: '餘額不足，正在調用錢包...', lotteryWalletCancel: '錢包支付已取消或失敗', lotteryNoComments: '暫無評論', seriousNotice: '鄭重提示', maxDonation: '最高可受捐', prize1: '一等獎', prize2: '二等獎', prize3: '三等獎', prize4: '四等獎', coinUnitLottery: '枚', howToPlay: '玩法說明', lotteryDescDetail: '投入整數枚數（最少1枚），系統按先來後到分配連續號碼。號碼售完後系統自動隨機開獎，獎金即時發放到餘額。', wishSuccess1: '許願成功', wishSuccess2: '心想事成', announcement: '系統公告', publishAnnouncement: '發布公告', charityApplyBtn: '困難慈善救助申請', charityName: '姓名', charityGender: '性別', charityPhoto: '照片', charityCountry: '國家', charityCity: '城市', charityHelpType: '需要什麼幫助', charityReason: '申請理由', charityAmount: '申請金額', charityProof: '證明材料', charitySubmit: '提交申請', charityGoalNote: '目標籌款額 = 申請金額 × 5', charityDonate: '捐款', charityDonateNow: '立即捐款', charitySupport: '支持', charityOppose: '反對', charityVoteNote: '只有保險節點用戶可投票，每個項目一票，不可更改。', charityComments: '評論', charityCommentPh: '寫下評論...', charitySend: '發送', charityRaised: '已籌', charityGoal: '目標', charityRequested: '申請', charityNoProjects: '暫無救助申請', charityHowToPlay: '幫助說明', charityBack: '返回', charityDonated: '已捐款', charityDonor: '捐款人',
  ...
  ja: {
    ...
    dockHome: 'ホーム', dockLottery: '慈善', dockBbs: '広場', dockIns: '保険', dockMe: 'マイ', disclaimerTitle: '重大声明', disclaimerAgree: '読んで同意します', lotteryTitle: 'ラッキー抽選プール', lotteryMainTitle: '誰もが寄付を必要としている', lotterySubtitle: '最大5000枚まで', lotteryRulesTitle: '遊び方', lotteryRule1: 'ラッキープールを選び、整数枚（最小1枚）を投入。番号は先着順に連続で割り当てられます。', lotteryRule2: '番号が完売すると、システムが自動的にランダム抽選。完全に公平で透明、誰でも当選番号を確認できます。', lotteryRule3: '賞金は自動的に残高に入金され、すぐに出金可能。保留・申請・審査なし。', lotteryRule4: 'すべての番号の当選確率は同じ。購入するほど当選チャンスが増えます。抽選後は自動的に次のラウンドが開始。', lotteryRule5: 'プラットフォームは運営と慈善寄付のため5%の手数料を徴収。良い人には良い報いが。幸運を！', seriousNotice: '重大なお知らせ', maxDonation: '最高寄付金額', prize1: '一等賞', prize2: '二等賞', prize3: '三等賞', prize4: '四等賞', coinUnitLottery: '枚', howToPlay: '遊び方', lotteryDescDetail: '整数枚数を投入（最小1枚）。番号は先着順に連続で割り当てられます。完売後、システムが自動的にランダム抽選。賞金は即座に残高に入金されます。', wishSuccess1: '願いが叶いました', wishSuccess2: '夢が叶いますように', announcement: 'お知らせ', publishAnnouncement: '公開する', charityApplyBtn: '困難慈善救助申請', charityName: '名前', charityGender: '性別', charityPhoto: '写真', charityCountry: '国', charityCity: '都市', charityHelpType: '必要な支援', charityReason: '申請理由', charityAmount: '申請金額', charityProof: '証明資料', charitySubmit: '申請を送信', charityGoalNote: '目標額 = 申請額 × 5', charityDonate: '寄付', charityDonateNow: '今すぐ寄付', charitySupport: '支持', charityOppose: '反対', charityVoteNote: '保険ノードを持つユーザーのみ投票可能。プロジェクトごとに1票、変更不可。', charityComments: 'コメント', charityCommentPh: 'コメントを書く...', charitySend: '送信', charityRaised: '調達済', charityGoal: '目標', charityRequested: '申請', charityNoProjects: 'まだ救助申請がありません', charityHowToPlay: '支援内容', charityBack: '戻る', charityDonated: '寄付済', charityDonor: '寄付者',
