...
const I18N = {
  ...
  insOnBar: '保險生效中', insOffBar: '保險關閉中',
    ...
    wdOk: '提現已發送', wdCheckReceive: '請注意查收。', wdPending: '已提交，待平台處理。', regionTitle: '地区验证', regionTip: '没有邀请人的用户首次提现前必须验证所在地区。', regionCountry: '国家', regionRegion: '省/州', regionCity: '市/镇', regionDistrict: '区/县', regionTown: '镇/街道', regionSubmit: '提交并继续', regionRequired: '所有字段必填', myInviter: '我的直推人',
  ...
  insOnBar: '保険有効中', insOffBar: '保険OFF',
    ...
    wdOk: '送金しました。', wdCheckReceive: 'ウォレットへの着金をご確認ください。', wdPending: '送信済み。プラットフォーム処理待ち。', regionTitle: '所在地確認', regionTip: '招待者のいないユーザーは初回出金前に所在地を確認する必要があります。', regionCountry: '国', regionRegion: '省/州', regionCity: '市/町', regionDistrict: '区/郡', regionTown: '町/街', regionSubmit: '送信して続行', regionRequired: 'すべての項目が必須です', myInviter: '招待者',
  ...
  ko: {
    ...
    wdOk: '출금이 전송되었습니다.', wdCheckReceive: '지갑에서 입금을 확인해 주세요.', wdPending: '접수되었습니다. 플랫폼 처리 대기 중.', regionTitle: '위치 인증', regionTip: '초대자가 없는 사용자는 첫 출금 전에 위치를 인증해야 합니다.', regionCountry: '국가', regionRegion: '도/주', regionCity: '시/군', regionDistrict: '구/군', regionTown: '읍/면/동', regionSubmit: '제출 및 계속', regionRequired: '모든 필드는 필수입니다', myInviter: '초대자',
...
async function submitRegion() {
  ...
  try {
    ...
    if (r.user) {
      ...
      const wdBtn = $('wdBtn'); wdBtn.disabled = true; wdBtn.textContent = t('withdrawing');
      try {
        await alignWallet();
      ...
      finally { wdBtn.disabled = false; wdBtn.textContent = t('withdraw'); }
    }
  } catch (e) { alert(e.message); }
