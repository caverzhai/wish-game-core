...
const I18N = {
  ...
  'zh-TW': {
    coinUnit: '枚', platformTitle: '全球自助慈善捐助平台', platformDesc: '阿姆斯特丹團隊致力為全球有需要的人士提供直接捐助，以區塊鏈模式，公開、公正、可追溯的自由捐贈撮合服務，除了讓需要的人得到無損資助外，讓愛心人士也能得到肯定和收益。受所屬國家法律保護，相關證書展示在保險區。', appTitle: '三分鐘願望池', loginTip: '連接錢包即可開始，邀請連結自動綁定推薦關係', connectWallet: '連接錢包', demoEnter: '未裝錢包？以演示身份進入', logout: '退出',
